...
@section('content')
    ...
    <span class="badge bg-primary border border-dark text-white px-3 py-2 filter-btn active cursor-pointer" data-category="all">
        Semua
    </span>
    <span class="badge bg-kuning border border-dark text-white px-3 py-2 filter-btn cursor-pointer" data-category="Makanan">
        Makanan
    </span>
    <span class="badge bg-happy border border-dark text-white px-3 py-2 filter-btn cursor-pointer" data-category="Minuman">
        Minuman
    </span>
    <span class="badge bg-orange border border-dark text-white px-3 py-2 filter-btn cursor-pointer" data-category="Snack">
        Snack
    </span>
    </div>
...
@foreach ($items as $item)
    <div class="col-6 col-md-6 col-lg-6 col-xl-4 menu-card mb-4"
        ...
        <div class="rounded position-relative fruite-item border border-happy border-top-0 rounded-bottom h-100 d-flex flex-column">
