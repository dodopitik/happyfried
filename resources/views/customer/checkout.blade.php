...
@section('content')
    ...
    <div class="container-fluid page-header py-5">
        ...
        <ol class="breadcrumb justify-content-center mb-0">
            <li class="breadcrumb-item active text-primary">Silahkan pilih Konfirmasi pesanan</li>
        </ol>
    </div>
        ...
        <div class="container py-5">
            ...
            <form id="checkout-form" action="{{ route('checkout.store') }}" method="POST">
                ...
                <div class="row g-5">
                    ...
                    @php
                        $tax = $subTotal * 0.11; // Assuming a 11% tax rate
                        $total = $subTotal + $tax;
                    @endphp
                    <div class="col-md-12 col-lg-6 col-xl-6">
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            payButton.addEventListener("click", function() {
                ...
                if (!paymentMethod) {
                    alert("Pilih Metode Pembayaran Telebih Dahulu ! ");
                    return;
                }
                    ...
                    fetch("{{ route('checkout.store') }}", {
                        ...
                        .then(data => {
                            if (data.snap_token) {
                                ...
                                alert(
                                    "terjadi kesalahan saat memproses pembayaran , silahkan coba lagi "
                                );
                            }
                        })
                        .catch(error => {
                            console.error("error", error);
                            alert("Terjadi kesalahan , silahkan coba lagi catch ")
                        })
                }
